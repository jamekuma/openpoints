...
class LocalGrouper(nn.Module):
    def __init__(self, channel, sample_ratio, kneighbors, resampler, use_xyz=True, normalize="center", **kwargs):
        """
...
class PointMLPEncoder_Resampling(nn.Module):
    def __init__(self, in_channels=3, embed_dim=64, groups=1, res_expansion=1.0,
        ...
        for i in range(len(pre_blocks)):
            ...
            local_grouper = LocalGrouper(last_channel, reduce, kneighbor, self.resampler, use_xyz, normalize)  # [b,g,k,d]
    ...
    def forward_cls_feat(self, p, x=None):
        ...
        return x, self.resampler.get_loss()

@MODELS.register_module()
class PointMLP_Resampling(PointMLPEncoder_Resampling):
